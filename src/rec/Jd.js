...
const Jd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.firstName || !formData.lastName || !formData.email || !formData.phone || !formData.jobTitle || !formData.country || !formData.company || !formData.service || !formData.message || !file) {
        ...
        try {
            const response = await axios.post('https://api.t-talents.com/send-jd', formDataToSend, {
                ...
                <div className='flex flex-col gap-16 md:flex-row'>
                    <div className='flex flex-row flex-1'>
                        <div className='left-section flex flex-col gap-6 justify-start items-start'>
                            ...
                            We know how to identify the best talent in the world of telecommunications, technology, data centres, digital and fintech.
                            Submit your job vacancy to begin your recruitment process. Let us know your details and we’ll contact you to find out how we can help your business
                            </div>
